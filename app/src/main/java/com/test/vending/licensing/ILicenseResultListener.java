...
public static abstract class Stub extends android.os.Binder implements com.test.vending.licensing.ILicenseResultListener
{
 ...
 */
public static com.test.vending.licensing.ILicenseResultListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.test.vending.licensing.ILicenseResultListener))) {
return ((com.test.vending.licensing.ILicenseResultListener)iin);
}
return new com.test.vending.licensing.ILicenseResultListener.Stub.Proxy(obj);
}
...
private static class Proxy implements com.test.vending.licensing.ILicenseResultListener
{
